...
public class Spline  extends Item implements MouseListener, MouseMotionListener, Serializable{
	...
	Spline (ShapedWindow sw,String title, int type){
		super(0, sw, type);
		this.setTitle(title);
		this.c = Color.black;
		this.curveWidth = 1;
