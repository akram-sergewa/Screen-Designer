...
//	}
	...
	public TextEditor(Main Main) {
		...
		fontList.setBounds(34, 13, 182, 22);
		contentPane.add(fontList);
		
		fontSize = new JComboBox();
		fontSize.setBounds(228, 13, 75, 22);
		...
		fontStyle.setBounds(314, 13, 75, 22);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				internalFrame.addItem(getLabel(), isShowCurve(), isAutorotation(), Item.TEXT);
				setVisible(false);
			}
		});
