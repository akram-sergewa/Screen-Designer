...
public class BrushEditor extends JInternalFrame {
	...
	public BrushEditor(Main Main) {
		...
		btnApply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//updateOutput();
				internalFrame.applyBrushChanges(getBrushColor(), sliderCurveWidth.getValue(), isShowShadow(), isAutorotation(),sliderDistance.getValue(),  sliderRotation.getValue(), sliderShadowSize.getValue(), shadowColor, sliderTransparent.getValue());
				setVisible(false);
			}
		});
		...
		btnBrushColor = new JButton("Brush Color");
		btnBrushColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				internalFrame.showColorChooser(ColorEditor.BRUSHCOLOR, Item.BRUSH);

			}
		});
		btnBrushColor.setBounds(309, 179, 113, 25);
		contentPane.add(btnBrushColor);
